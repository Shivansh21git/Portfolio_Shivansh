...
# --------------------------------------------Resume section start----------------------------------------------
 ...
 with st.container():
  ...
  <form target="_blank" action="https://formsubmit.co/shivanshchauhan.228@gmail.com" method="POST">
    ...
    <button type="submit" class="btn btn-lg btn-dark btn-block" style="background-color: #0dedc0; color: #d33682; padding: 12px; border: none; border-radius: 5px; width: 100%; margin-top: 20px;">Submit Form</button>
  </form>
</div>
